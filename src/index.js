...
(async () => {
  ...
  const loadReserves = async () => {
    ...
    var current_chartdata = [
      reservesData[0].assets[0].total = reservesData[0].assets[0].total - reserveBaseData[1].value,
      reservesData[0].assets[1].total = reservesData[0].assets[1].total + reserveBaseData[1].value,
